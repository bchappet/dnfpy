...
class MapDNFNSpike(FieldMap):
    def __init__(self,name,size,dt=0.1,wrap=True,
                 ...
                 **kwargs):
        super(MapDNFNSpike,self).__init__(name,size,dt=dt,wrap=wrap,tau=tau,h=h,th=th,nspike=nspike,model=model,iExc=iExc,iInh=iInh,pExc=pExc,pInh=pInh,alpha=alpha,reproductible=reproductible,**kwargs)
