...
class LateralWeightsMapLin(Map2D):
    """
    ...
    def __init__(self,name,globalSize,mapSize=1,dt=1e10,wrap=True,
                 ...
                 **kwargs):
        super(LateralWeightsMapLin,self).__init__(
    ...
    def getScaledParams(size,globalSize,mapSize,alpha,alphaExc,alphaInh,betaExc,betaInh):
        ...
        betaExc_ = betaExc/(globalSize**3) * (40**2)/alpha
        betaInh_ = betaInh/(globalSize**3) * (40**2)/alpha
    ...
    def _onParamsUpdate(self,size,globalSize,mapSize,alpha,alphaExc,alphaInh,betaExc,betaInh):
        return self.getScaledParams(size,globalSize,mapSize,alpha,alphaExc,alphaInh,betaExc,betaInh)
