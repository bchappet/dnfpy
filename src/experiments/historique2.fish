...
python3 runExperiment2.py --models "['ModelNSpike']" --kwmodel "{'cell':'Rsdnf','routerType':'sequence','reproductible':False,'nspike':5,'model':'spike','clkRatio':238}" --prefix "NSpike_distr_sequence_nspike5"  --nbThread 8  --scenarios "['ScenarioDistracters',]"
...
#sequence vs noise
python3 runExperiment2.py --models "['ModelNSpike']" --kwmodel "{'cell':'Rsdnf','routerType':'sequence','reproductible':False,'nspike':1,'model':'spike','clkRatio':130}" --prefix "NSpike_noise_sequence_nspike1"  --nbThread 8  --scenarios "['ScenarioNoise',]"
python3 runExperiment2.py --models "['ModelNSpike']" --kwmodel "{'cell':'Rsdnf','routerType':'sequence','reproductible':False,'nspike':5,'model':'spike','clkRatio':238}" --prefix "NSpike_noise_sequence_nspike5"  --nbThread 8  --scenarios "['ScenarioNoise',]"
